...
# Modefiyed by yinflying 2017/08/06
#       send the corrected string to buffer(eveyone in channel can see)
#
...
SCRIPT_AUTHOR = 'Chris Johnson <raugturi@gmail.com> yinflying<yinflying@foxmail.com>'
SCRIPT_VERSION = '1.2.1'
SCRIPT_LICENSE = 'GPL3'
SCRIPT_DESC = "When a correction (ex: s/typo/replacement) is sent, sent the "\
              "user's previous message(s) with the corrected text behind"
